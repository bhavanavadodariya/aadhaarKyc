...
import com.khoslalabs.util.GsonSerializerUtil;
...
public class AadhaarKYCAsyncTask extends AsyncTask<Object, Void, String> {
	...
	public AadhaarKYCAsyncTask(Context ctx, KycI kycI) {
		this.ctx = ctx;
		this.kycI = kycI;
	}
	...
	protected String doInBackground(Object... params) {
		...
		HttpPost httppost = new HttpPost(AadhaarKYCActivity.BASE_URL + "/kyc/raw");
		...
		try {
			...
			if (response != null && response.getStatusLine().getStatusCode() == 200) {
				...
				Log.e("Bhavana", "response code "+response.getStatusLine().getStatusCode());
				return "";
			}
		} catch (Exception e) {
